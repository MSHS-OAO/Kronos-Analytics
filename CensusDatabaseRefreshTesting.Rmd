...
```{r Determine and set root path, echo = FALSE}
...
```{r Connect to Epic Clarity database and pull latest census data, echo = FALSE, error = TRUE}
print("Start")
...
```{r Save census summary as RDS, echo = FALSE}
...
```{r Functions to write census to temporary table and merge with repository, echo = FALSE}
...
```{r Call custom functions to write and merge data to database, echo = TRUE, error = TRUE}
